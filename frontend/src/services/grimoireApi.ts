...
With the API service ready, we can now build the main Library page.

**What File We Will Produce Next:**
The page file for the `/grimoire` route.

**File to Create 2:** `frontend/src/app/grimoire/page.tsx`
